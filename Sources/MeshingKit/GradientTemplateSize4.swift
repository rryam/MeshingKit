...
public enum GradientTemplateSize4: String, CaseIterable, GradientTemplate {
    case auroraBorealis
    case sunsetHorizon
    case mysticForest
    case cosmicNebula
    ...
    public var points: [SIMD2<Float>] {
        ...
        case .sunsetHorizon:
            return [
                ...
                .init(x: 0.700, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.250), .init(x: 0.352, y: 0.641),
                .init(x: 0.609, y: 0.131), .init(x: 1.000, y: 0.200),
        ...
        case .mysticForest:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.350, y: 0.000),
                .init(x: 0.650, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.400), .init(x: 0.181, y: 0.471),
                .init(x: 0.882, y: 0.225), .init(x: 1.000, y: 0.300),
        ...
        case .cosmicNebula:
            return [
                ...
                .init(x: 0.800, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.447), .init(x: 0.253, y: 0.317),
                .init(x: 0.300, y: 0.175), .init(x: 1.000, y: 0.404),
        ...
        case .coralReef:
            return [
                ...
                .init(x: 0.600, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.300), .init(x: 0.708, y: 0.589),
                .init(x: 0.844, y: 0.343), .init(x: 1.000, y: 0.400),
        ...
        case .etherealTwilight:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.333, y: 0.000),
                .init(x: 0.667, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.333), .init(x: 0.421, y: 0.512),
                .init(x: 0.739, y: 0.187), .init(x: 1.000, y: 0.333),
        ...
        case .volcanicOasis:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.333, y: 0.000),
                .init(x: 0.667, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.333), .init(x: 0.218, y: 0.456),
                .init(x: 0.789, y: 0.123), .init(x: 1.000, y: 0.333),
        ...
        case .arcticFrost:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.333, y: 0.000),
                .init(x: 0.667, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.333), .init(x: 0.678, y: 0.543),
                .init(x: 0.234, y: 0.876), .init(x: 1.000, y: 0.333),
        ...
        case .jungleMist:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.333, y: 0.000),
                .init(x: 0.667, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.333), .init(x: 0.123, y: 0.789),
                .init(x: 0.876, y: 0.432), .init(x: 1.000, y: 0.333),
        ...
        case .desertMirage:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.333, y: 0.000),
                .init(x: 0.667, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.333), .init(x: 0.789, y: 0.234),
                .init(x: 0.456, y: 0.901), .init(x: 1.000, y: 0.333),
        ...
        case .neonMetropolis:
            return [
                .init(x: 0.000, y: 0.000), .init(x: 0.333, y: 0.000),
                .init(x: 0.667, y: 0.000), .init(x: 1.000, y: 0.000),
                .init(x: 0.000, y: 0.333), .init(x: 0.543, y: 0.210),
                .init(x: 0.876, y: 0.789), .init(x: 1.000, y: 0.333),
    ...
    public var colors: [Color] {
        ...
        case .auroraBorealis:
            return [
                Color(hex: "#00264d"), Color(hex: "#004080"),
                Color(hex: "#0059b3"), Color(hex: "#0073e6"),
                Color(hex: "#1a8cff"), Color(hex: "#4da6ff"),
                Color(hex: "#80bfff"), Color(hex: "#b3d9ff"),
        ...
        case .sunsetHorizon:
            return [
                Color(hex: "#ff6600"), Color(hex: "#ff8533"),
                Color(hex: "#ffa366"), Color(hex: "#ffc199"),
                Color(hex: "#ffb3ba"), Color(hex: "#ff99a7"),
                Color(hex: "#ff8093"), Color(hex: "#ff6680"),
        ...
        case .mysticForest:
            return [
                Color(hex: "#004d00"), Color(hex: "#006600"),
                Color(hex: "#008000"), Color(hex: "#009900"),
                Color(hex: "#00b300"), Color(hex: "#00cc00"),
                Color(hex: "#00e600"), Color(hex: "#00ff00"),
        ...
        case .cosmicNebula:
            return [
                Color(hex: "#1a1a33"), Color(hex: "#33334d"),
                Color(hex: "#4d4d66"), Color(hex: "#666680"),
                Color(hex: "#8080b3"), Color(hex: "#9999cc"),
                Color(hex: "#b3b3e6"), Color(hex: "#ccccff"),
        ...
        case .coralReef:
            return [
                Color(hex: "#004d66"), Color(hex: "#006680"),
                Color(hex: "#008099"), Color(hex: "#0099b3"),
                Color(hex: "#00b3cc"), Color(hex: "#00cce6"),
                Color(hex: "#00e6ff"), Color(hex: "#1affff"),
        ...
        case .etherealTwilight:
            return [
                Color(hex: "#2e0059"), Color(hex: "#420080"),
                Color(hex: "#5600a6"), Color(hex: "#6a00cc"),
                Color(hex: "#7f00f2"), Color(hex: "#9933ff"),
                Color(hex: "#b366ff"), Color(hex: "#cc99ff"),
        ...
        case .volcanicOasis:
            return [
                ...
                Color(hex: "#cc0000"), Color(hex: "#ff0000"),
                Color(hex: "#ff3300"), Color(hex: "#ff6600"),
                Color(hex: "#ff9900"), Color(hex: "#ffcc00"),
        ...
        case .arcticFrost:
            return [
                Color(hex: "#ffffff"), Color(hex: "#f0f8ff"),
                Color(hex: "#e6f2ff"), Color(hex: "#ccebff"),
                Color(hex: "#b3e0ff"), Color(hex: "#99d6ff"),
                Color(hex: "#80ccff"), Color(hex: "#66c2ff"),
        ...
        case .jungleMist:
            return [
                Color(hex: "#264d00"), Color(hex: "#336600"),
                Color(hex: "#408000"), Color(hex: "#4d9900"),
                Color(hex: "#59b300"), Color(hex: "#66cc00"),
                Color(hex: "#73e600"), Color(hex: "#80ff00"),
        ...
        case .desertMirage:
            return [
                Color(hex: "#fff2d9"), Color(hex: "#ffedcc"),
                Color(hex: "#ffe6b3"), Color(hex: "#ffdf99"),
                Color(hex: "#ffd480"), Color(hex: "#ffcc66"),
                Color(hex: "#ffc34d"), Color(hex: "#ffbb33"),
        ...
        case .neonMetropolis:
            return [
                Color(hex: "#1a0033"), Color(hex: "#330066"),
                Color(hex: "#4d0099"), Color(hex: "#6600cc"),
